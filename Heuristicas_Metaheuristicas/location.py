...
def main():
    ...
    Resolucao(2022056242, 200, 50, 5)
    print("2022056242, 300, 100, 7")
    Resolucao(2022056242, 300, 100, 7)
    print("2022056242, 400, 100, 7")
    Resolucao(2022056242, 400, 100, 7)
    
    print("2022056242, 500, 100, 5")
    Resolucao(2022056242, 500, 100, 5)
    print("2022056242, 500, 100, 7")
    Resolucao(2022056242, 500, 100, 7)
    print("2022056242, 500, 100, 10")
    Resolucao(2022056242, 500, 100, 10)
    
    print("2022056242, 600, 100, 5")
    Resolucao(2022056242, 600, 100, 5)
    print("2022056242, 600, 100, 7")
